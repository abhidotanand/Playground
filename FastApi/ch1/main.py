...
# @app.get("/items/{item_id}")
# def read_item(item_id: int) -> ReturnItem:
#     return ReturnItem(
#         item_id=item_id,
#         name="Sample Item",
...
# PRODUCTS_DB = {
#     1: {"id":1 ,"name": "Laptop", "price": 1000, "description": "A high-performance laptop."},
#     2: {"id": 2, "name": "Smartphone", "price": 500, "description": "A latest model smartphone."},
#     3: {"id": 3, "name": "Tablet", "price": 300, "description": "A lightweight tablet."},
# }
...
#     name: str
#     description: str
#     tax: float = 15 #Default tax rate

# @app.get("/items/{item_id}", response_model=Item, response_model_exclude_unset=True)
# def read_item(item_id: int):
#     return PRODUCTS_DB.get(item_id)
